...
metricsExpression:
  ...
  | metricsExpression ADD scalar  %prec ADD                   { $$ = scalarRight(OpAdd,  $3.Float(), $1) }
  | metricsExpression SUB scalar  %prec SUB                   { $$ = scalarRight(OpSub,  $3.Float(), $1) }
  | metricsExpression MUL scalar  %prec MUL                   { $$ = scalarRight(OpMult, $3.Float(), $1) }
  | metricsExpression DIV scalar  %prec DIV                   { $$ = scalarRight(OpDiv,  $3.Float(), $1) }
  | scalar ADD metricsExpression  %prec ADD                   { $$ = scalarLeft(OpAdd,  $1.Float(), $3) }
  | scalar SUB metricsExpression  %prec SUB                   { $$ = scalarLeft(OpSub,  $1.Float(), $3) }
  | scalar MUL metricsExpression  %prec MUL                   { $$ = scalarLeft(OpMult, $1.Float(), $3) }
  | scalar DIV metricsExpression  %prec DIV                   { $$ = scalarLeft(OpDiv,  $1.Float(), $3) }
  ;
