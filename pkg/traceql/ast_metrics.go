...
func newTopKBottomK(op SecondStageOp, limit int, separator string) *TopKBottomK {
...
func newMetricsFilter(op Operator, value float64, separator string) *MetricsFilter {
