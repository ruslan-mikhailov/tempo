...
// MatchedGroups returns 0 as vparquet4 does not support batch metrics query tagging.
// This is a stub implementation to satisfy the traceql.Span interface.
func (s *span) MatchedGroups() uint64 {
	return 0
}

// SetMatchedGroups is a no-op as vparquet4 does not support batch metrics query tagging.
// This is a stub implementation to satisfy the traceql.Span interface.
